# -*- coding: utf-8 -*-
"""Verify 1398 stats with cross-checks. Run: python scripts/year_1398_stats_verify.py"""
import sys
...
# Step 1: Verify date boundaries for 1398
start_1398 = jdatetime.date(1398, 1, 1).togregorian()
start_1399 = jdatetime.date(1399, 1, 1).togregorian()
s = start_1398.isoformat()
e = start_1399.isoformat()

print("=== تایید بازه سال 1398 ===")
print("شروع 1398 (شمسی): 1398/01/01")
print("شروع 1398 (میلادی):", start_1398)
print("پایان بازه - قبل از 1399/01/01 (میلادی):", start_1399)
...
print("=== نتایج نهایی سال 1398 (تایید شده) ===")
print()
