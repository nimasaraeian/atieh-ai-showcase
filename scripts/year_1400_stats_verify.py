# -*- coding: utf-8 -*-
"""Verify 1400 stats with cross-checks. Run: python scripts/year_1400_stats_verify.py"""
import sys
...
# Step 1: Verify date boundaries for 1400
start_1400 = jdatetime.date(1400, 1, 1).togregorian()
start_1401 = jdatetime.date(1401, 1, 1).togregorian()
s = start_1400.isoformat()
e = start_1401.isoformat()

print("=== تایید بازه سال 1400 ===")
print("شروع 1400 (شمسی): 1400/01/01")
print("شروع 1400 (میلادی):", start_1400)
print("پایان بازه - قبل از 1401/01/01 (میلادی):", start_1401)
...
print("=== نتایج نهایی سال 1400 (تایید شده) ===")
print()
