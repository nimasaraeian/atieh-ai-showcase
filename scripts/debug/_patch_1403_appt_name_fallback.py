...
old = '''    c_name = _find_col(col_index, APPOINTMENT_NAME_HEADERS)
    c_phone = _find_col(col_index, APPOINTMENT_PHONE_HEADERS)'''

new = '''    c_name = _find_col(col_index, APPOINTMENT_NAME_HEADERS)
...
if old not in text:
    print("ERROR: appointment target block not found")
    sys.exit(1)
