# -*- coding: utf-8 -*-
"""Verify 1401 stats with cross-checks. Run: python scripts/year_1401_stats_verify.py"""
import sys
...
# Step 1: Verify date boundaries for 1401
start_1401 = jdatetime.date(1401, 1, 1).togregorian()
start_1402 = jdatetime.date(1402, 1, 1).togregorian()
s = start_1401.isoformat()
e = start_1402.isoformat()

print("=== تایید بازه سال 1401 ===")
print("شروع 1401 (شمسی): 1401/01/01")
print("شروع 1401 (میلادی):", start_1401)
print("پایان بازه - قبل از 1402/01/01 (میلادی):", start_1402)
...
print("=== نتایج نهایی سال 1401 (تایید شده) ===")
print()
