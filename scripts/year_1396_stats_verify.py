# -*- coding: utf-8 -*-
"""Verify 1396 stats with cross-checks. Run: python scripts/year_1396_stats_verify.py"""
import sys
...
# Step 1: Verify date boundaries for 1396
start_1396 = jdatetime.date(1396, 1, 1).togregorian()
start_1397 = jdatetime.date(1397, 1, 1).togregorian()
s = start_1396.isoformat()
e = start_1397.isoformat()

print("=== تایید بازه سال 1396 ===")
print("شروع 1396 (شمسی): 1396/01/01")
print("شروع 1396 (میلادی):", start_1396)
print("پایان بازه - قبل از 1397/01/01 (میلادی):", start_1397)
...
print("=== نتایج نهایی سال 1396 (تایید شده) ===")
print()
