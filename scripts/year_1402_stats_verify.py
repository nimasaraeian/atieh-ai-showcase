# -*- coding: utf-8 -*-
"""Verify 1402 stats with cross-checks. Run: python scripts/year_1402_stats_verify.py"""
import sys
...
# Step 1: Verify date boundaries for 1402
start_1402 = jdatetime.date(1402, 1, 1).togregorian()
start_1403 = jdatetime.date(1403, 1, 1).togregorian()
s = start_1402.isoformat()
e = start_1403.isoformat()

print("=== تایید بازه سال 1402 ===")
print("شروع 1402 (شمسی): 1402/01/01")
print("شروع 1402 (میلادی):", start_1402)
print("پایان بازه - قبل از 1403/01/01 (میلادی):", start_1403)
...
print("=== نتایج نهایی سال 1402 (تایید شده) ===")
print()
