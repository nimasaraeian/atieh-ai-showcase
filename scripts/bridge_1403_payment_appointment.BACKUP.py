...
# Column candidates
PAYMENT_DATE_HEADERS = ["ØªØ§Ø±ÙŠØ® Ù¾Ø°ÙŠØ±Ø´", "ØªØ§Ø±ÛŒØ® Ù¾Ø°ÛŒØ±Ø´", "ØªØ§Ø±ÙŠØ®", "ØªØ§Ø±ÛŒØ®"]
PAYMENT_NAME_HEADERS = ["Ù†Ø§Ù… Ø¨ÙŠÙ…Ø§Ø±", "Ù†Ø§Ù… Ø¨ÛŒÙ…Ø§Ø±", "Ù†Ø§Ù… Ø¨ÛŒÙ…Ø§Ø±(ØªØ´Ú©ÛŒÙ„ Ù¾Ø±ÙˆÙ†Ø¯Ù‡ Ø´Ø¯Ù‡)"]
PAYMENT_PHONE_HEADERS = ["Ù…ÙˆØ¨Ø§ÙŠÙ„", "Ù…ÙˆØ¨Ø§ÛŒÙ„", "ØªÙ„ÙÙ†", "Ø´Ù…Ø§Ø±Ù‡ ØªÙ…Ø§Ø³"]
PAYMENT_RECORDNO_HEADERS = ["Ø´Ù…Ø§Ø±Ù‡ Ù¾Ø±ÙˆÙ†Ø¯Ù‡", "Ú©Ø¯ Ù¾Ø±ÙˆÙ†Ø¯Ù‡", "record_no", "Ù¾Ø±ÙˆÙ†Ø¯Ù‡"]

APPT_DATE_HEADERS = ["ØªØ§Ø±ÙŠØ® Ù†ÙˆØ¨Øª", "ØªØ§Ø±ÛŒØ® Ù†ÙˆØ¨Øª", "ØªØ§Ø±ÛŒØ®", "ØªØ§Ø±ÙŠØ®"]
APPT_NAME_HEADERS = [
    "Ù†Ø§Ù… Ø¨ÛŒÙ…Ø§Ø±(ØªØ´Ú©ÛŒÙ„ Ù¾Ø±ÙˆÙ†Ø¯Ù‡ Ø´Ø¯Ù‡)",
    "Ù†Ø§Ù… Ø¨ÙŠÙ…Ø§Ø±(ØªØ´ÙƒÙŠÙ„ Ù¾Ø±ÙˆÙ†Ø¯Ù‡ Ø´Ø¯Ù‡)",
    "Ù†Ø§Ù… Ùˆ Ù†Ø§Ù… Ø®Ø§Ù†ÙˆØ§Ø¯Ú¯ÛŒ",
    "Ù†Ø§Ù… Ø¨ÛŒÙ…Ø§Ø±",
]
APPT_PHONE_HEADERS = ["Ù…ÙˆØ¨Ø§ÛŒÙ„", "Ù…ÙˆØ¨Ø§ÙŠÙ„", "ØªÙ„ÙÙ†", "Ø´Ù…Ø§Ø±Ù‡ ØªÙ…Ø§Ø³", "ØªÙ„ÙÙ† Ù‡Ù…Ø±Ø§Ù‡"]
