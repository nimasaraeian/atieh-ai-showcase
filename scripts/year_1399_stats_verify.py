# -*- coding: utf-8 -*-
"""Verify 1399 stats with cross-checks. Run: python scripts/year_1399_stats_verify.py"""
import sys
...
# Step 1: Verify date boundaries for 1399
start_1399 = jdatetime.date(1399, 1, 1).togregorian()
start_1400 = jdatetime.date(1400, 1, 1).togregorian()
s = start_1399.isoformat()
e = start_1400.isoformat()

print("=== تایید بازه سال 1399 ===")
print("شروع 1399 (شمسی): 1399/01/01")
print("شروع 1399 (میلادی):", start_1399)
print("پایان بازه - قبل از 1400/01/01 (میلادی):", start_1400)
...
print("=== نتایج نهایی سال 1399 (تایید شده) ===")
print()
