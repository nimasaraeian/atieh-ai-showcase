...
export function getStatusKey(value) {
  ...
  const map = { completed: 'status.completed', pending: 'status.pending', cancelled: 'status.cancelled', confirmed: 'status.confirmed', inprogress: 'status.inProgress', noshow: 'status.no_show' }
